...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { is_pass: @choice.is_pass, ordinality: @choice.ordinality, question_id: @choice.question_id, text: @choice.text, voice_count: @choice.voice_count } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { is_pass: @choice.is_pass, ordinality: @choice.ordinality, question_id: @choice.question_id, text: @choice.text, voice_count: @choice.voice_count } }
